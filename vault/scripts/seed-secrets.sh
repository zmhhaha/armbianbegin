...
COMPONENTS["secret/data/literature-downloader/api"]="Literature Downloader academic API credentials（ACADEMIC_CONTACT_EMAIL, SEMANTIC_SCHOLAR_API_KEY）"
...
COMPONENTS["secret/data/zhougongjiemeng-agent/api"]="周公解梦 Agent API Key（DEEPSEEK_API_KEY, OPENAI_API_KEY, CUSTOM_API_KEY）"
...
KEY_MAP["secret/data/literature-downloader/api"]="ACADEMIC_CONTACT_EMAIL SEMANTIC_SCHOLAR_API_KEY"
...
KEY_MAP["secret/data/zhougongjiemeng-agent/api"]="DEEPSEEK_API_KEY DEEPSEEK_BASE_URL DEEPSEEK_MODEL OPENAI_API_KEY CUSTOM_API_KEY"
