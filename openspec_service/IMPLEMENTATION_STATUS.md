...
- Kubernetes namespace、workspace PVC、ExternalSecret、ClusterIP Service、Cloudflare TunnelRoute；
...
- 在真实 Casdoor 创建应用并确认 issuer、audience、JWKS 和 Gitea OAuth/OIDC 映射；
